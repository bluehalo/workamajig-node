...
WorkamajigError.generate = function(rawWorkamajigError) {
  ...
  return new _Error('AHHHHHH', rawWorkamajigError.type || 'Unknown Error');
};

/**
 * 
 */
WorkamajigError.generateMultiStatusError = function(errors) {
...
_Error.WorkamajigMultiStatusError = WorkamajigError.extend({
  generate: function(){}
});
