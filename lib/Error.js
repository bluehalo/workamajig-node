...
WorkamajigError.generate = function(rawWorkamajigError) {
  switch (rawWorkamajigError) {
    case 'authentication_error':
      return new _Error.WorkamajigAuthenticationError(rawWorkamajigError);
    case 'invalid_request_error':
      return new _Error.WorkamajigInvalidRequestError(rawWorkamajigError);
    case 'api_error':
      return new _Error.WorkamajigAPIError(rawWorkamajigError);
  }
  return new _Error('Generic', rawWorkamajigError || 'Unknown Error');
};
