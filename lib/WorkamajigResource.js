        ...
        try {
          ...
          if(resp.statusCode >= 400) {
            ...
            if (resp.statusCode === 401) {
              wmjError = new Error.WorkamajigAuthenticationError(body.description);
            } else if (resp.statusCode === 403) {
              wmjError = new Error.WorkamajigPermissionError(body.description);
            } else if (resp.statusCode === 429) {
              wmjError = new Error.WorkamajigRateLimitError(body.description);
            } else {
              wmjError = Error.WorkamajigError.generate(body.description);
            }
