...
var utils = module.exports = {
  ...
  isOptionsHash: function(o) {
    return isPlainObject(o) && ['api_key', 'idempotency_key', 'workamajig_account'].some(function(key) {
  ...
  getOptionsFromArgs: function(args) {
    ...
    if (args.length > 0) {
      ...
      if (utils.isAuthKey(arg)) {
        ...
        if (params.workamajig_account) {
          opts.headers['Workamajig-Account'] = params.workamajig_account;
        }
      }
    }
    return opts;
